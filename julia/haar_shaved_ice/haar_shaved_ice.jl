...
I=load("shaved_ice.jpg");

G=Gray.(I);
# size(G)

A=imresize(G, ratio=1/4);
...
savefig("haar_shaved_ice_level0.png")
...
plot(Gray.(B1), 
    ...
    grid=false, 
    title="Level 1 (haar)")
savefig("haar_shaved_ice_level1.png")
...
savefig("haar_shaved_ice_level1_a.png")
...
savefig("haar_shaved_ice_level2_a.png")
...
savefig("haar_shaved_ice_level3_a.png")
...
savefig("haar_shaved_ice_level4_a.png")
...
savefig("haar_shaved_ice_level4_d.png")
