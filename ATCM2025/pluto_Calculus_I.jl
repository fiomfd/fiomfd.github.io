...
# ╔═╡ 7b96af08-2465-48b5-a6e6-f0f005b74ac5
...
# ╔═╡ 4aba7f3c-a190-4984-9c7c-618b1a88d677
...
# ╔═╡ 1d4d7492-fde9-4a4f-a809-1d1156dee9ef
begin
	...
	for k=0:K
	    for l=1:301
	        s3[k+1,l]=(-1)^k*y[l]^(2*k+1)/factorial(big(2*k+1));
        end
	end
	S3=zeros(K+1,301);
	S3[1,:]=s3[1,:];
...
# ╔═╡ bac01998-2c95-41bf-a103-808a5798a5f4
md"""
#### Example: $\sin{x}$
...
K = $(@bind l3 Slider(0:K, show_value=true))
"""

# ╔═╡ 0759eaf0-cad4-4e29-b87a-d75e3a65f73d
begin
	h3=S3[l3+1,:];
...
# ╔═╡ 34c862a7-3889-4dc3-ae78-1ea7785bbde9
md"""
...
# ╔═╡ f2c3e5e9-00fb-4edb-b2f7-61b7e17582a5
begin
...
# ╔═╡ 059f3537-8e1e-497e-9f51-a0bed6b761ab
begin
    plot(f5,
...
manifest_format = "2.0"
project_hash = "5f872de792df325268f08e37f049f2cc6d54b733"
