...
begin
    plot(f,
	     ...
	     grid=false,
	     ylim=[0,2.7],
	     yticks=([0 0.5 2.7;],[0,"m","M"]),
	     xticks=([0 501;],["a","b"]),
		 xlabel=("x"),
		 ylabel=("y"),
	     legend=false)
    plot!([1,1],[0.5,2.7], c=:magenta)
	plot!([1,501],[2.7,2.7], c=:magenta)
    plot!([501,501],[2.7,0.5], c=:magenta)
    plot!([501,1],[0.5,0.5], c=:magenta)
end
...
md"""
n= $(@bind n Slider(5:500, show_value=true))
"""
...
begin
	g=zeros(n);
	for j=1:n
		g[j]=sin.(2*pi*(2*j-1)/2/n)+(2*j-1)/2/n+1.2;
	end
end
...
plot(f,
    ...
    plot!([501,501],[0,f[501]], c=:magenta)
	plot!([1,501],[0,0], c=:red)
end
...
plot(h,
    ...
    plot!([501,501],[0,f[501]], c=:magenta)
	plot!([1,501],[0,0], c=:red)
	plot!([251,251],[f[251],h[251]], c=:lightgreen,lw=3)
end
...
plot(f,
    ...
    plot!([501,501],[1.8,f[501]], c=:magenta)
	plot!([1,501],[1.8,1.8], c=:red,lw=2)
end
...
julia_version = "1.8.0"
manifest_format = "2.0"
project_hash = "e1c3c234c04397465ee63990ee33b6dc171a82c0"
